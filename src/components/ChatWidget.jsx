...
export default function ChatWidget({ embedConfig = { isEmbed: false, agentId: null } }) {
  ...
  const header = (
    <div style={{
      ...
      {/* ── Logo: swap LOGO_URL to your image path or import ── */}
      <div style={{
        ...
        <img
          ...
          onError={e => {
            // Fallback: hide the broken image, show the green dot instead
            e.target.style.display = 'none'
            e.target.nextSibling.style.display = 'block'
          }}
        />
        {/* Fallback dot — shown automatically if logo fails to load */}
        <div style={{
          display: 'none',
